...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserPostListView, PostCommentView, ModPostListView, ModPostCreateView, ModPostDeleteView, ModPostDetailView, ModPostUpdateView, ModUserPostListView
